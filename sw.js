...
// Cache automático: no hace falta cambiar la versión a mano.
const CACHE = 'panini-auto-cache-v1-copyfix;
const APP_SHELL = [
  './',
  './index.html',
  './style.css',
...
self.addEventListener('fetch', event => {
  ...
  // HTML/JS/CSS/manifest: primero red, así los cambios de GitHub Pages entran solos.
