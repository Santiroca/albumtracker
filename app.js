...
const tutorialSteps = [
  ...
  },
  {
    ...
    text:'Acá tenés todo ordenado: compartir, backups, ayuda rápida, actualización y borrar álbum.',
    before:()=>goTab('config'),
    target:'#panel-config',
    items:[
      ['📨','Compartir','Mandá faltantes o copiá repetidas.'],
      ['📦','Backups y carga','Exportá o importá tu colección.'],
      ['🗑️','Zona peligrosa','Borrar álbum queda separado al final.']
    ],
    hint:'También podés volver a abrir este tutorial desde Más.'
  }
]
...
async function shareMissingList(){
  const missingCount = ALL_IDS.filter(id => !col[id]).length;
...
const PWA_CURRENT_CACHE = 'panini-auto-cache-v33-update-system-clean';
