...
function genQR(){
  ...
  try{
    ...
    // URL too long — encode only dupes
...
function launchConfetti(teamName){
  ...
  div.textContent = msg;
  div.style.cssText = 'position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);background:var(--s1);border:2px solid var(--accent);border-radius:14px;padding:18px 28px;font-family:Bebas Neue,sans-serif;font-size:1.4rem;letter-spacing:2px;color:var(--accent);z-index:1000;text-align:center;box-shadow:0 8px 32px rgba(0,0,0,.5);';
