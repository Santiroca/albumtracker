...
function importFromFiguritas(){
  ...
  const msg = `Esto reemplaza tu colección actual.\n\nDetecté ${parsed.missingCount} faltantes y ${parsed.dupesCount} repetidas.\n\n¿Importar desde Figuritas?`;
  ...
  const ignored = parsed.unknown.length ? ` · ${parsed.unknown.length} ignoradas` : '';
  toast(`Figuritas importado${ignored}`,'ok');
}
