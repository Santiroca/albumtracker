...
const TUTORIAL_KEY = 'pn26_tutorial_seen_v2';
let tutorialStep = 0;
...
const tutorialSteps = [
  ...
  },
  {
    ...
    before:()=>goTab('dupes'),
    target:()=>document.getElementById('bn-dupes') || document.getElementById('snb-dupes'),
    items:[
...
function renderTutorial(){
  ...
  document.getElementById('tutorial-count').textContent = `${tutorialStep + 1}/${tutorialSteps.length}`;
  ...
  document.getElementById('tutorial-next').textContent = tutorialStep === tutorialSteps.length - 1 ? 'Terminar' : 'Siguiente';
