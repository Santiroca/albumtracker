...
function updateStats(){
  ...
  // iPhone album summary
  setText('iphone-summary-pct', Math.round(got/TOTAL*100)+'%');
  setText('iphone-summary-total', TOTAL);
  setText('iphone-summary-miss', miss);
  setText('iphone-summary-got', got);
  const iphoneDonut = document.getElementById('iphone-summary-donut');
  if(iphoneDonut) iphoneDonut.style.setProperty('--pct', got/TOTAL*100);
